    ...
    return (
        <section className="brew-section" id="brew">
            <div className="brew-header">
                ...
                <h2>Tea & Brew Collection</h2>
                <p>
                    Refresh your moments with fruity brew teas and traditional premium
                    beverages crafted for every season.
                </p>
            </div>

            <div className="brew-grid">
                {teaProducts.map((item, index) => (
                    <div className="brew-card" key={index}>
